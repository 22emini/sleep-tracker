...
const AboutPage = () => {
  return (
    <div className="font-sans bg-gradient-to-br from-slate-50 to-blue-50 text-gray-800 min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center justify-center text-center py-24 px-8">
          <div className="flex items-center justify-center mb-8">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-full mr-4 animate-pulse">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center group">
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-2xl w-fit mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      {/* Story Section */}
      <section className="py-20 px-8 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 relative overflow-hidden">
      ...
      <section className="py-20 px-8 bg-gradient-to-br from-slate-50 to-blue-50 text-center">
